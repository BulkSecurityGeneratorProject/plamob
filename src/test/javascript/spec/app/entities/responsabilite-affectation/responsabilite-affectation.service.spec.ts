...
describe('Service Tests', () => {
    ...
    describe('ResponsabiliteAffectation Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ResponsabiliteAffectationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/responsabilite-affectations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ResponsabiliteAffectation', () => {
